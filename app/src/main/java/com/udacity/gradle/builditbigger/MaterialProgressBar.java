...
/**
 * Created by paskalstoyanov on 14/02/16.
 */

/*
* This is a MaterialProgressBar from https://blog.stylingandroid.com/material-progressbar/
* The original version on GitHub:
* https://github.com/StylingAndroid/MaterialProgressBar
* The only change made to make it compatible with the current version
* was to make the minimum API level 14.
* Given the statistic, this is worthwhile.
*/
